...
namespace Langben.App.Controllers
{
    ...
    public class DepartmentController : BaseController
    {
        ...
        public JsonResult GetData(string id, int page, int rows, string order, string sort, string search)
        {
            ...
            int total = 0;
            List<Department> queryData = m_BLL.GetByParam(id, page, rows, order, sort, search, ref total);
        ...
        public ActionResult Export(string id, string title, string field, string sortName, string sortOrder, string search)
        {
            ...
            List<Department> queryData = m_BLL.GetByParam(id, sortOrder, sortName, search);
        ...
        {
            Department item = m_BLL.GetById(id);
            return View(item);
        ...
        {           
            if (entity != null && ModelState.IsValid)
            {
                ...
                {
                    LogClassModels.WriteServiceLog(Suggestion.InsertSucceed  + "，组织架构的信息的Id为" + entity.id,"组织架构"
                        );//写入日志 
                ...
                { 
                    ...
                    LogClassModels.WriteServiceLog(Suggestion.InsertFail + "，组织架构的信息，" + returnValue,"组织架构"
                        );//写入日志                      
        ...
        [HttpPost]
        [SupportFilter]
        public ActionResult Edit(string id, Department entity)
        {
            if (entity != null && ModelState.IsValid)
            {   //数据校验
                ...
                {
                    LogClassModels.WriteServiceLog(Suggestion.UpdateSucceed + "，组织架构信息的Id为" + id,"组织架构"
                        );//写入日志                           
                ...
                { 
                    ...
                    LogClassModels.WriteServiceLog(Suggestion.UpdateFail + "，组织架构信息的Id为" + id + "," + returnValue, "组织架构"
                        );//写入日志                           
        ...
        IBLL.IDepartmentBLL m_BLL;

        ValidationErrors validationErrors = new ValidationErrors();

        public DepartmentController()
            : this(new DepartmentBLL()) { }
