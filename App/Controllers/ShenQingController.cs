...
namespace Langben.App.Controllers
{
    ...
    /// 维修申请
    /// </summary>
    public class ShenQingController : BaseController
    {
        ...
        public JsonResult GetData(string id, int page, int rows, string order, string sort, string search)
        {
            ...
            int total = 0;
            List<ShenQing> queryData = m_BLL.GetByParam(id, page, rows, order, sort, search, ref total);
        ...
        public ActionResult Export(string id, string title, string field, string sortName, string sortOrder, string search)
        {
            ...
            List<ShenQing> queryData = m_BLL.GetByParam(id, sortOrder, sortName, search);
        ...
        IBLL.IShenQingBLL m_BLL;

        ValidationErrors validationErrors = new ValidationErrors();

        public ShenQingController()
            : this(new ShenQingBLL()) { }

        public ShenQingController(ShenQingBLL bll)
        {
            m_BLL = bll;
        }
