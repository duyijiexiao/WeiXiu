...
namespace Models
{
    public class Validator
    {
        ...
        public static int IsPassword(string pwd)
        {
            if (string.IsNullOrWhiteSpace(pwd))
            {
                return 1;
            } 
            if (pwd.Length >= 100 && pwd.Length <= 6)
            {
                return 2;
            }
            if (IsNumber(pwd))
        ...
        /// <returns></returns>
        private static bool IsIDCard18(string strln)
        {
            long n = 0;
        ...
        /// <param name="strln">输入的字符</param>
        /// <returns></returns>
        private static bool IsIDCard15(string strln)
        {
            long n = 0;
