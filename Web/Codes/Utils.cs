...
namespace Models
{
    public abstract class Utils
    {
        ...
        public static void WriteCookie(string strname, string strvalue, double days)
        {
        ...
        public static void WriteCookie(string strname, Common.Account mycookie, double days)
        {
            HttpCookie cookie = HttpContext.Current.Request.Cookies[strname];
            if (cookie == null)
                cookie = new HttpCookie(strname);
