...
namespace Langben.DAL
{
    ...
    /// 学校单位
    /// </summary>
    public partial class SchoolRepository : BaseRepository<School>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<School> DaoChuData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<School>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取学校单位---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>学校单位</returns>
        ...
        /// <param name="id">主键</param>
        /// <returns>学校单位</returns>
        public School GetById(SysEntities db, string id)
        { 
            return db.School.SingleOrDefault(s => s.Id == id);
        ...
        /// <param name="id">一条学校单位的主键</param>
        public void Delete(SysEntities db, string id)
        {
            School deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.School.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<School> collection = from f in db.School
