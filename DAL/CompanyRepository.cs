...
namespace Langben.DAL
{
    ...
    public partial class CompanyRepository : BaseRepository<Company>, IDisposable
    {
        ...
        /// <returns></returns>      
        public IQueryable<Company> DaoChuData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
