...
namespace Langben.DAL
{
    ...
    /// 通讯录
    /// </summary>
    public partial class MemberRepository : BaseRepository<Member>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<Member> DaoChuData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<Member>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取通讯录---查看详细，首次编辑
        /// </summary>
        ...
        { 
            return db.Member.SingleOrDefault(s => s.userid == id);
        ...
        public void Delete(SysEntities db, string[] deleteCollection)
        {
            ...
            IQueryable<Member> collection = from f in db.Member
                    where deleteCollection.Contains(f.userid)
                    select f;
