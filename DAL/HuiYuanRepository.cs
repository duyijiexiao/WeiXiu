...
namespace Langben.DAL
{
    ...
    public partial class HuiYuanRepository : BaseRepository<HuiYuan>, IDisposable
    {
        ...
        /// <returns></returns>      
        public IQueryable<HuiYuan> DaoChuData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<HuiYuan>().Where(string.IsNullOrEmpty(where) ? "true" : where)
        ...
        /// <param name="id">主键</param>
        /// <returns>会员</returns>
        public HuiYuan GetById(SysEntities db, string id)
        { 
            return db.HuiYuan.SingleOrDefault(s => s.Id == id);
        ...
        {
            HuiYuan deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.HuiYuan.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<HuiYuan> collection = from f in db.HuiYuan
