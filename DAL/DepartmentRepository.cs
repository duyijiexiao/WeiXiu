...
namespace Langben.DAL
{
    ...
    /// 组织架构
    /// </summary>
    public partial class DepartmentRepository : BaseRepository<Department>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<Department> DaoChuData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<Department>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取组织架构---查看详细，首次编辑
        /// </summary>
        ...
        /// <param name="id">主键</param>
        /// <returns>组织架构</returns>
        public Department GetById(SysEntities db, string id)
        { 
            return db.Department.SingleOrDefault(s => s.id == id);
        ...
        /// <param name="id">一条组织架构的主键</param>
        public void Delete(SysEntities db, string id)
        {
            Department deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.Department.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<Department> collection = from f in db.Department
