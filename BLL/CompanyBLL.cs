...
namespace Langben.BLL
{
    ...
    public partial class CompanyBLL :  IBLL.ICompanyBLL, IDisposable
    {
        ...
        {
            IQueryable<Company> queryData = repository.DaoChuData(db, order, sort, search);
        ...
        /// </summary>
        /// <param name="validationErrors">返回的错误信息</param>
        /// <param name="deleteCollection">企业的集合</param>
        /// <returns></returns>    
        ...
        /// 根据主键获取一个企业
        /// </summary>
        /// <param name="id">企业的主键</param>
        /// <returns>一个企业</returns>
